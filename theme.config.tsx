...
export default {
  ...
  search: {
    emptyResult: <div className="text-center">Hech narsa topilmadi</div>,
  ...
  footer: {
    text: (
      <div className="w-full text-center">💙️ ila ⌨️ yordamida siz uchun!</div>
    ),
  },
};
